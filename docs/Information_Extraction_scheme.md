...
head: [src_entity_id, src_entity_type, tar_entity_id, tar_entity_type, relation_label_id, relation_type, relation_label_repr, event_id, event_trigger, event_type, event_time, tar_entity_match_text, tar_entity_match_pattern_type]. 
