...
re_ref_patterns = {
    ...
    'SHA': [r'https?://(?:www\.|redirect\.)?github(?:-redirect\.dependabot)?\.com/[A-Za-z0-9][-0-9a-zA-Z]*/[A-Za-z0-9][-_0-9a-zA-Z\.]*/pull/\d+/commits/[0-9a-fA-F]{40}(?![0-9a-fA-F/#])', r'https?://(?:www\.|redirect\.)?github(?:-redirect\.dependabot)?\.com/[A-Za-z0-9][-0-9a-zA-Z]*/[A-Za-z0-9][-_0-9a-zA-Z\.]*/commit/[0-9a-fA-F]{40}(?![0-9a-fA-F/#])', r'(?:(?<=[\s\(\[:])|(?<=^))([0-9a-fA-F]{40})(?![0-9a-fA-F/#])', r'(?:(?<=[\s\(\[:])|(?<=^))([0-9a-fA-F]{7})(?![0-9a-zA-Z/#])'],  # 包含Commit的sha，以及未知类型实体的sha
    'Actor': [r'https?://(?:www\.|redirect\.)?github(?:-redirect\.dependabot)?\.com/[A-Za-z0-9][-0-9a-zA-Z]*(?![-A-Za-z0-9/])', r'(?:(?<=[\s\(\[])|(?<=^))(@[A-Za-z0-9][-0-9a-zA-Z]*)(?![-A-Za-z0-9/])', r'\w[-\w.+]*@(?:[A-Za-z0-9][-A-Za-z0-9]+\.)+[A-Za-z]{2,14}'],
    'Repo': [r'https?://(?:www\.|redirect\.)?github(?:-redirect\.dependabot)?\.com/[A-Za-z0-9][-0-9a-zA-Z]*/[A-Za-z0-9][-_0-9a-zA-Z\.]*(?![-_A-Za-z0-9\./])'],
    'Branch_Tag_GHDir': [r'https?://(?:www\.|redirect\.)?github(?:-redirect\.dependabot)?\.com/[A-Za-z0-9][-0-9a-zA-Z]*/[A-Za-z0-9][-_0-9a-zA-Z\.]*/tree/[^\:\[\?\s\*\\\\,;\]`)]+(?!>[\:\[\?\s\*,#\|\+@\<\>≤≥\=≠\&$\{\}\]\";`])'],
    ...
    'GitHub_Other_Links': [r'(https?://(?:www\.|redirect\.)?github(?:-redirect\.dependabot)?\.com/[A-Za-z0-9][-0-9a-zA-Z]*/[A-Za-z0-9][-_0-9a-zA-Z\.]*/(?!issues|pull|commit|tree|wiki|releases|files|blob)[-_A-Za-z0-9\.%#/:]*(?![-_A-Za-z0-9\.%#/:]))'],
    'GitHub_Other_Service': [r'https?://(?!www\.)(?!redirect\.)[-a-zA-Z]+\.github(?:-redirect\.dependabot|usercontent)?\.com[-_A-Za-z0-9\.%#/:]*(?![-_A-Za-z0-9\.%#/:])'],
