...
re_ref_patterns = {
    ...
    'GitHub_Other_Service': [r'https?://(?!www\.)(?!redirect\.)[-a-zA-Z]+\.github(?:-redirect\.dependabot|usercontent)?\.com[-_A-Za-z0-9\.%#/:]*(?![-_A-Za-z0-9\.%#/:])', 'https?://(?!www\.)?github(?:-redirect\.dependabot)?\.com/apps/[-_A-Za-z0-9\.%#/:]*(?![-_A-Za-z0-9\.%#/:])'],
